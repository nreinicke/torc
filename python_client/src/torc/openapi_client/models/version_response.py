...
class VersionResponse(BaseModel):
    ...
    git_hash: Optional[StrictStr] = None
    version: StrictStr
    __properties: ClassVar[List[str]] = ["api_version", "git_hash", "version"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if git_hash (nullable) is None
        # and model_fields_set contains the field
        if self.git_hash is None and "git_hash" in self.model_fields_set:
            _dict['git_hash'] = None
