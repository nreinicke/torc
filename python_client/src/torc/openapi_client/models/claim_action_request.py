...
class ClaimActionRequest(BaseModel):
    ...
    ClaimActionRequest
    """ # noqa: E501
    compute_node_id: StrictInt = Field(description="ID of the compute node claiming the action")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClaimActionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClaimActionRequest from a dict"""
        if obj is None:
            return None
