...
class ListJobDependenciesResponse(BaseModel):
    """
    ListJobDependenciesResponse
    """ # noqa: E501
    items: List[JobDependencyModel]
    offset: StrictInt
    max_limit: StrictInt
    count: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListJobDependenciesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListJobDependenciesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [JobDependencyModel.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
