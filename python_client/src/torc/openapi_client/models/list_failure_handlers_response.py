...
class ListFailureHandlersResponse(BaseModel):
    """
    ListFailureHandlersResponse
    """ # noqa: E501
    items: List[FailureHandlerModel]
    offset: StrictInt
    max_limit: StrictInt
    count: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListFailureHandlersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListFailureHandlersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [FailureHandlerModel.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
