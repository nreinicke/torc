...
class WorkflowsApi:
    ...
    @validate_call
    def batch_complete_jobs(
        self,
        id: Annotated[StrictInt, Field(description="Workflow ID")],
        batch_complete_jobs_request: BatchCompleteJobsRequest,
        ...
        :type id: int
        :param batch_complete_jobs_request: (required)
        :type batch_complete_jobs_request: BatchCompleteJobsRequest
        ...
        _param = self._batch_complete_jobs_serialize(
            id=id,
            batch_complete_jobs_request=batch_complete_jobs_request,
    ...
    @validate_call
    def batch_complete_jobs_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Workflow ID")],
        batch_complete_jobs_request: BatchCompleteJobsRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatchCompleteJobsResponse]:
        """batch_complete_jobs
    ...
    @validate_call
    def batch_complete_jobs_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Workflow ID")],
        batch_complete_jobs_request: BatchCompleteJobsRequest,
        _request_timeout: Union[
    ...
    def _batch_complete_jobs_serialize(
        self,
        id,
        batch_complete_jobs_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if batch_complete_jobs_request is not None:
            _body_params = batch_complete_jobs_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/workflows/{id}/batch_complete_jobs',
