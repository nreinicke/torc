...
class SlurmSchedulersApi:
    ...
    def create_slurm_scheduler(
        self,
        slurm_scheduler_model: SlurmSchedulerModel,
        ...
        :param slurm_scheduler_model: (required)
        :type slurm_scheduler_model: SlurmSchedulerModel
        ...
        _param = self._create_slurm_scheduler_serialize(
            slurm_scheduler_model=slurm_scheduler_model,
    ...
    @validate_call
    def create_slurm_scheduler_with_http_info(
        self,
        slurm_scheduler_model: SlurmSchedulerModel,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_slurm_scheduler_without_preload_content(
        self,
        slurm_scheduler_model: SlurmSchedulerModel,
        _request_timeout: Union[
            None,
    ...
    def _create_slurm_scheduler_serialize(
        self,
        ...
        if slurm_scheduler_model is not None:
            _body_params = slurm_scheduler_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/slurm_schedulers',
    ...
    def _delete_slurm_scheduler_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/slurm_schedulers/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_slurm_scheduler(
        ...
        _param = self._get_slurm_scheduler_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_slurm_scheduler_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Slurm compute node configuration ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_slurm_scheduler_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Slurm compute node configuration ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_slurm_scheduler_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_slurm_schedulers(
        ...
        _param = self._list_slurm_schedulers_serialize(
            workflow_id=workflow_id,
            offset=offset,
            limit=limit,
            sort_by=sort_by,
    ...
    @validate_call
    def list_slurm_schedulers_with_http_info(
        self,
        workflow_id: StrictInt,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
    ...
    @validate_call
    def list_slurm_schedulers_without_preload_content(
        self,
        workflow_id: StrictInt,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
    ...
    def _list_slurm_schedulers_serialize(
        self,
        workflow_id,
        offset,
        limit,
    ...
    def update_slurm_scheduler(
        ...
        _param = self._update_slurm_scheduler_serialize(
            id=id,
            slurm_scheduler_model=slurm_scheduler_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_slurm_scheduler_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Slurm compute node configuration ID")],
        slurm_scheduler_model: SlurmSchedulerModel,
        _request_timeout: Union[
    ...
    @validate_call
    def update_slurm_scheduler_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Slurm compute node configuration ID")],
        slurm_scheduler_model: SlurmSchedulerModel,
        _request_timeout: Union[
    ...
    def _update_slurm_scheduler_serialize(
        self,
        id,
        slurm_scheduler_model,
        _request_auth,
