...
Base.@kwdef mutable struct ListEventsResponse <: OpenAPI.APIModel
    ...
    function ListEventsResponse(count, has_more, items, max_limit, offset, total_count, )
...
const _property_types_ListEventsResponse = Dict{Symbol,String}(Symbol("count")=>"Int64", Symbol("has_more")=>"Bool", Symbol("items")=>"Vector{EventModel}", Symbol("max_limit")=>"Int64", Symbol("offset")=>"Int64", Symbol("total_count")=>"Int64", )
...
function OpenAPI.validate_property(::Type{ ListEventsResponse }, name::Symbol, val)
    ...
    if name === Symbol("count")
        OpenAPI.validate_param(name, "ListEventsResponse", :format, val, "int64")
    end
