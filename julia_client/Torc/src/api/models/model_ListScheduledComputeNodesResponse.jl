...
@doc raw"""ListScheduledComputeNodesResponse
...
Base.@kwdef mutable struct ListScheduledComputeNodesResponse <: OpenAPI.APIModel
    ...
    function ListScheduledComputeNodesResponse(count, has_more, items, max_limit, offset, total_count, )
...
const _property_types_ListScheduledComputeNodesResponse = Dict{Symbol,String}(Symbol("count")=>"Int64", Symbol("has_more")=>"Bool", Symbol("items")=>"Vector{ScheduledComputeNodesModel}", Symbol("max_limit")=>"Int64", Symbol("offset")=>"Int64", Symbol("total_count")=>"Int64", )
...
function OpenAPI.validate_properties(o::ListScheduledComputeNodesResponse)
    ...
    OpenAPI.validate_property(ListScheduledComputeNodesResponse, Symbol("has_more"), o.has_more)
...
function OpenAPI.validate_property(::Type{ ListScheduledComputeNodesResponse }, name::Symbol, val)
    ...
    if name === Symbol("count")
        OpenAPI.validate_param(name, "ListScheduledComputeNodesResponse", :format, val, "int64")
    end
