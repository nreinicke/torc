...
Base.@kwdef mutable struct ListJobsResponse <: OpenAPI.APIModel
    ...
    function ListJobsResponse(count, has_more, items, max_limit, offset, total_count, )
...
const _property_types_ListJobsResponse = Dict{Symbol,String}(Symbol("count")=>"Int64", Symbol("has_more")=>"Bool", Symbol("items")=>"Vector{JobModel}", Symbol("max_limit")=>"Int64", Symbol("offset")=>"Int64", Symbol("total_count")=>"Int64", )
...
function OpenAPI.validate_property(::Type{ ListJobsResponse }, name::Symbol, val)
    ...
    if name === Symbol("count")
        OpenAPI.validate_param(name, "ListJobsResponse", :format, val, "int64")
    end
