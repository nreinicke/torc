-- Remove step_nodes from resource_requirements.
-- num_nodes is now used for both the Slurm allocation size (sbatch --nodes)
-- and the per-step node count (srun --nodes).
--
